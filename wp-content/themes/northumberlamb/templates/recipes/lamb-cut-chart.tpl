        ...
        <div class="box ">
            <div class="col-md-12 text-center">
                ...
                <div class="btn-group" role="group" style="margin-bottom: 10px;">
                    ...
                    <button class="btn btn-default" type="submit" id="btnNutritionalInfo">Nutritional Information</button>
                </div>
                ...
                <div>
                    Filter recipes by clicking on the the desired cut of lamb.
                </div>
